      ...
      >
        ...
        <div className="relative z-40 p-8">
          <motion.p
            ...
            className="text-white text-sm md:text-base font-medium font-sans text-left flex space-x-2"
          >
            {card.tags?.edges?.map((tag) => (
              <p className="bg-standard w-fit rounded p-0.5">
                {tag?.node?.name}
              </p>
            ))}
          </motion.p>
