...
export enum CommentStatusEnum {
  /** Comments with the Goedgekeurd status */
  Approve = 'APPROVE',
  /** Comments with the Geweigerd status */
  Hold = 'HOLD',
  /** Comments with the Spam status */
  Spam = 'SPAM',
  /** Comments with the Prullenbak status */
  Trash = 'TRASH'
}
...
export type DiscussionSettings = {
  ...
  /** Sta link meldingen toe van andere blogs (pingbacks en trackbacks) op nieuwe artikelen. */
...
export type GeneralSettings = {
  ...
  /** Een datumnotatie voor alle datum strings. */
  dateFormat?: Maybe<Scalars['String']['output']>;
  /** Site slogan. */
  description?: Maybe<Scalars['String']['output']>;
  /** Dit adres wordt gebruikt voor administratieve doeleinden, zoals meldingen voor nieuwe gebruikers. */
  email?: Maybe<Scalars['String']['output']>;
  /** WordPress locale code. */
  language?: Maybe<Scalars['String']['output']>;
  /** Nummer van de dag waarop de week zou moeten beginnen. */
  startOfWeek?: Maybe<Scalars['Int']['output']>;
  /** Een tijdnotatie voor alle tijd strings. */
  timeFormat?: Maybe<Scalars['String']['output']>;
  /** Een stad in dezelfde tijdzone als jij. */
...
export enum MediaItemSizeEnum {
  /** MediaItem with the et-pb-gallery-module-image-portrait size */
  EtPbGalleryModuleImagePortrait = 'ET_PB_GALLERY_MODULE_IMAGE_PORTRAIT',
  /** MediaItem with the et-pb-image--responsive--desktop size */
  EtPbImageResponsiveDesktop = 'ET_PB_IMAGE__RESPONSIVE__DESKTOP',
  /** MediaItem with the et-pb-image--responsive--phone size */
  EtPbImageResponsivePhone = 'ET_PB_IMAGE__RESPONSIVE__PHONE',
  /** MediaItem with the et-pb-image--responsive--tablet size */
  EtPbImageResponsiveTablet = 'ET_PB_IMAGE__RESPONSIVE__TABLET',
  /** MediaItem with the et-pb-portfolio-image size */
  EtPbPortfolioImage = 'ET_PB_PORTFOLIO_IMAGE',
  /** MediaItem with the et-pb-portfolio-image-single size */
  EtPbPortfolioImageSingle = 'ET_PB_PORTFOLIO_IMAGE_SINGLE',
  /** MediaItem with the et-pb-portfolio-module-image size */
  EtPbPortfolioModuleImage = 'ET_PB_PORTFOLIO_MODULE_IMAGE',
  /** MediaItem with the et-pb-post-main-image size */
  EtPbPostMainImage = 'ET_PB_POST_MAIN_IMAGE',
  /** MediaItem with the et-pb-post-main-image-fullwidth size */
  EtPbPostMainImageFullwidth = 'ET_PB_POST_MAIN_IMAGE_FULLWIDTH',
  /** MediaItem with the et-pb-post-main-image-fullwidth-large size */
  EtPbPostMainImageFullwidthLarge = 'ET_PB_POST_MAIN_IMAGE_FULLWIDTH_LARGE',
...
export type ReadingSettings = {
  ...
  /** Het ID van de pagina die de nieuwste berichten moet tonen */
  pageForPosts?: Maybe<Scalars['Int']['output']>;
  /** Het ID van de pagina die moet worden getoond op de voorpagina */
  pageOnFront?: Maybe<Scalars['Int']['output']>;
  /** Blogpagina&#039;s tonen hoogstens. */
  postsPerPage?: Maybe<Scalars['Int']['output']>;
  /** Wat te tonen op de voorpagina */
...
export type UpdateSettingsInput = {
  ...
  /** Standaard bericht format. */
  writingSettingsDefaultPostFormat?: InputMaybe<Scalars['String']['input']>;
  /** Zet emoticons zoals :-) en :-P bij weergave om in afbeeldingen. */
...
export type GetOnePostQuery = { __typename?: 'RootQuery', post?: { __typename?: 'Post', id: string, date?: string | null, slug?: string | null, title?: string | null, content?: string | null, uri?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null } } | null, tags?: { __typename?: 'PostToTagConnection', edges: Array<{ __typename?: 'PostToTagConnectionEdge', node: { __typename?: 'Tag', id: string, name?: string | null } }> } | null } | null };

export type GetAllJourneysQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllJourneysQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', id: string, title?: string | null, date?: string | null, slug?: string | null, content?: string | null, tags?: { __typename?: 'PostToTagConnection', edges: Array<{ __typename?: 'PostToTagConnectionEdge', node: { __typename?: 'Tag', id: string, name?: string | null } }> } | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null } } | null }> } | null };
 ...
 * });
 */
export function useGetOnePostQuery(baseOptions: Apollo.QueryHookOptions<GetOnePostQuery, GetOnePostQueryVariables> & ({ variables: GetOnePostQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useGetOnePostSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOnePostQuery, GetOnePostQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetOnePostQuery, GetOnePostQueryVariables>(GetOnePostDocument, options);
        }
...
/**
 * __useGetAllJourneysQuery__
 *
 * To run a query within a React component, call `useGetAllJourneysQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllJourneysQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllJourneysQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllJourneysQuery(baseOptions?: Apollo.QueryHookOptions<GetAllJourneysQuery, GetAllJourneysQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllJourneysQuery, GetAllJourneysQueryVariables>(GetAllJourneysDocument, options);
      }
export function useGetAllJourneysLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllJourneysQuery, GetAllJourneysQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllJourneysQuery, GetAllJourneysQueryVariables>(GetAllJourneysDocument, options);
        }
export function useGetAllJourneysSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllJourneysQuery, GetAllJourneysQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllJourneysQuery, GetAllJourneysQueryVariables>(GetAllJourneysDocument, options);
        }
export type GetAllJourneysQueryHookResult = ReturnType<typeof useGetAllJourneysQuery>;
export type GetAllJourneysLazyQueryHookResult = ReturnType<typeof useGetAllJourneysLazyQuery>;
export type GetAllJourneysSuspenseQueryHookResult = ReturnType<typeof useGetAllJourneysSuspenseQuery>;
export type GetAllJourneysQueryResult = Apollo.QueryResult<GetAllJourneysQuery, GetAllJourneysQueryVariables>;